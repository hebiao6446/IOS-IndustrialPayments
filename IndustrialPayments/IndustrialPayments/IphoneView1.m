...
-(id)init{
    ...
    if (self) {
        ...
        [backImage setImage:IMAGEWITHNAME(isIPhone5?@"iphone5view1back1":@"iphone4view1back1")];
        ...
        [oo setImage:IMAGEWITHNAME(isIPhone5?@"iphone5view1button2":@"iphone4view1button2") forState:UIControlStateNormal];
        [self addSubview:oo];
...
-(void)buttonAction:(OBShapedButton *)sender{
    ...
    [self.buttonDelegate iphoneViewButtonClickViewTag:1 butTag:sender.tag];
