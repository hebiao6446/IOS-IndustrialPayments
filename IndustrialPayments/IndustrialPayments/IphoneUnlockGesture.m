...
@implementation IphoneUnlockGesture
...
-(id)init{
    ...
    self = [super initWithFrame:CGRectMake(0, 0, 320, isIPhone5?568:480)];
    
    if (self) {
        // Initialization code
        
        self.backgroundColor=[UIColor colorWithPatternImage:[UIImage imageNamed:(isIPhone5?@"iphone5back.png":@"iphone4back.png")]];
        ...
        imagePhoto.center=CGPointMake(160, 70+(isIPhone5?30:0));
        ...
        nameLabel.frame=CGRectMake(0, 105+(isIPhone5?30:0), 320, 30);
        ...
        for (int i=0; i<9; i++) {
            ...
            [button setFrame:CGRectMake(26+(i%3)*98, 140+(i/3)*90+(isIPhone5?50:0), 72, 72)];
        ...
        forgetButton.center=CGPointMake(160, 525-(isIPhone5?24:88));
