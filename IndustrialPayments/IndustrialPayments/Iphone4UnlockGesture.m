...
#import "Iphone4UnlockGesture.h"

#import "ConstantPart.h"


@implementation Iphone4UnlockGesture
...
-(id)init{
    ...
    if (self) {
        ...
        self.backgroundColor=[UIColor colorWithPatternImage:[UIImage imageNamed:@"iphone4back.png"]];
        ...
        imagePhoto.center=CGPointMake(160, 70);
        ...
        nameLabel.frame=CGRectMake(0, 105, 320, 30);
        ...
        for (int i=0; i<9; i++) {
            ...
            [button setFrame:CGRectMake(26+(i%3)*98, 140+(i/3)*90, 72, 72)];
        ...
        forgetButton.center=CGPointMake(160, 525-88);
