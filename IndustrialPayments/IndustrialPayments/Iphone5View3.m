...
#import "Iphone5View3.h"

#import "ConstantPart.h"
#import "OBShapedButton.h"


@implementation Iphone5View3
...
-(id)init{
    ...
    if (self) {
        ...
        [backImage setImage:IMAGEWITHNAME(@"iphone5view3back7")];
        ...
        [oo setImage:IMAGEWITHNAME(@"iphone5view3button8") forState:UIControlStateNormal];
        [self addSubview:oo];
