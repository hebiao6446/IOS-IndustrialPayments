...
#import "Iphone4View1.h"

#import "HeadFile.h"
#import "OBShapedButton.h"

@implementation Iphone4View1
...
-(id)init{
    ...
    if (self) {
        ...
        [backImage setImage:IMAGEWITHNAME(@"iphone4view1back1")];
        ...
        [oo setImage:IMAGEWITHNAME(@"iphone4view1button2") forState:UIControlStateNormal];
        [self addSubview:oo];
